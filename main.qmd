...
::: incremental
- $Post_A \propto p^{52} (1-p)^{51}$
  - 52 heads out of 103 tosses?
- $Post_B \propto p^{60} (1-p)^{40} \times p^{50} (1-p)^{50}$
  - 110 heads out of 200 tosses?
- **Prior can legally increase your sample number using other information (misleading?)**
...
- $y_i = ax_i + b_j$
  ...
  - If the parameter $b_j$ is similar within each group (e.g., species differecne):
