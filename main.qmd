...
- The estimate shows larger variation
...
- This model uses a **prior** knowledge that species responses are some how similar and compensates the small data.
:::
...
- Model flexiblity for MLE is limited.
:::
:::
:::

::: notes
- You need to relay on funcitons, such as `lme4::glmer`.
:::
